    ...
    public function render($request, Throwable $e): Response
    {
        ...
        switch($e){
            ...
            case $e instanceof \kuro\exception\ValidateException :
                response(['_message' => $e->getMessage(), '_code' => 400, '_returnType' => 'InvalidArgumentException'], $e->getCode(), [], 'json')->send();
                exit;
            // 登陆auth异常
            ...
            case $e instanceof NotFoundException :
                response(['_message' => env('APP_DEBUG') ? $e->getMessage() : 'Not Found', '_code' => 404, '_returnType' => class_basename($e)], 404, [], 'json')->send();
                exit;
        }
        // 其他错误交给系统处理
        if(env('APP_DEBUG')) {
